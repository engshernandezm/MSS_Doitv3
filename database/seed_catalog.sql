...
SELECT '33333333-0001-0001-0000-000000000001'::uuid, 'operative', NULL::uuid, 500.00, 'block'  -- Gasolina: max 500 MXN para operativos
UNION ALL
SELECT '33333333-0005-0001-0000-000000000001'::uuid, 'operative', NULL::uuid, 1000.00, 'escalate' -- Viáticos: max 1000, escalar si excede
ON CONFLICT DO NOTHING;
